...
chibi.pco<-function(list_ohpco=NULL,col_val=NULL,shape_val=NULL,comp_a="PCo1",comp_b="PCo2",mypch=21,
                    size=25,alpha=0.7,stroke=1.5,col_shape_background="white",alpha_shape_background=0.7,
  ...
  if(is.null(shape_val)){
    p <- ggplot(data = Map_pco,aes_string(x = comp_a,y = comp_b))+
      ...
      theme(axis.line = element_blank(),
            ...
            axis.text.x = element_text(family = "AvantGarde",face = "plain",size =size_axis_text,colour="#414141",hjust = x_hjust),
            ...
            legend.background = element_blank(),legend.key.size = unit(legend_proportion_size,"point"),
