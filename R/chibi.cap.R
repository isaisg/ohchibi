...
chibi.cap<-function(list_ohpco=NULL,col_val=NULL,shape_val=NULL,comp_a=NULL,comp_b=NULL,mypch=21,
        ...
        ratio_size_shape_background=1.3,y_vjust=0.5,x_hjust=0.5,size_axis_text=12,size_axis_title=13,
  ...
  if(lines_zero == FALSE) {
    ...
    p <- ggplot(data = Map_cap,aes_string(x = comp_a,y = comp_b))+
      ...
      theme(axis.line = element_blank(),
            ...
            axis.title.x = element_text(family = font_family,face="plain",size = size_axis_title,colour = "black"),
            axis.title.y = element_text(family = font_family,face="bplain",size=size_axis_title,colour="black"),
