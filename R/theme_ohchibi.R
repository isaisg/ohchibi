...
theme_ohchibi <- function (size_axis_text.x = 20,size_axis_text.y = 20,
  ...
  theme(axis.line = element_blank(),
	...
	panel.grid.major.x = element_blank(),
        ...
        axis.text.x = element_text(family = font_family,face = "plain",size =size_axis_text.x,colour="black",hjust = x_hjust,angle = angle_text.x),
        axis.text.y = element_text(family = font_family,face="plain",size=size_axis_text.y,colour="black",vjust = y_vjust, angle = angle_text.y),
        axis.title.x = element_text(family = font_family,face="plain",size = size_axis_title.x,colour = "black"),
        axis.title.y = element_text(family = font_family,face="plain",size=size_axis_title.y,colour="black"),
        ...
        strip.text.x = element_text(family = font_family,colour = "black",size = size_strip_text.x),
        strip.text.y = element_text(family = font_family,colour = "black",size = size_strip_text.y),
