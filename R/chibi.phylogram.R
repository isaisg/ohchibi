...
chibi.phylogram<-function (Tab = NULL, Map = NULL, facet_formula = NULL, colname = "Sample",
  ...
  p1 <- ggplot(Dat, aes_string(x = colname, y = value.name,
    ...
    theme(
          ...
          axis.text.y = element_text(family = font_family,face="bold",size=size_axis_text,colour="blackg",vjust = y_vjust),
          axis.title.x = element_text(family = font_family,face="bold",size = size_axis_title,colour = "blackg"),
          axis.title.y = element_text(family = font_family,face="bold",size=size_axis_title,colour="blackg"),
          ...
          family = font_family,face = "bold",colour = "blackg"),
          legend.key = element_blank(),
          legend.text = element_text(size=size_legend_text,family = font_family,face = "bold",colour = "blackg"),
          legend.position ="right",strip.text.x = element_text(family = font_family,colour = "blackg",size = size_strip_text),
